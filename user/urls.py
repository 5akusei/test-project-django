...
from user.views import CreateRecord, ListRecord, UpdateRecord, DeleteRecord, Index, CreateRecordWithEmailConfirm, VerificationActivationCode
...
urlpatterns = [
    ...
    path('activar_usuario/<str:uid>', VerificationActivationCode.as_view(), name='activate'),
